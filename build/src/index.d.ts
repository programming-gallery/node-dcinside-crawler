 ...
 */
export declare type ThinDocument = Pick<DocumentHeader, 'id' | 'gallery'> & Partial<DocumentHeader>;
/**
 * Minimum Gallery information to fetch related data from dcinside
 */
export declare type ThinGallery = Pick<Gallery, 'id' | 'isMiner'> & Partial<Gallery>;
declare class RawCrawler {
    e_s_n_o: string;
    documentHeaders(gallery: ThinGallery, page: number): Promise<DocumentHeader[]>;
    comments(doc: ThinDocument, page?: number): Promise<{
        comments: Comment[];
        pageCount: number;
    }>;
}
