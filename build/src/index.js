...
class RawCrawler {
  ...
  weeklyActiveMajorGalleryIndexes() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const res = yield request_1.default.get(
      ...
      return JSON.parse(
        res.data.trim().slice(callbackParam.length + 1, -1)
      ).map(item => ({
        id: item.id,
        isMiner: false,
        name: item.ko_name,
  ...
  comments(doc, page = 1) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const pageCount = parseInt(
        Array.from(res.data.pagination.matchAll(/\d+/g), r => r[0]).pop()
      );
  ...
  documentHeaders(_options) {
    return __awaiter(this, void 0, void 0, function* () {
      const options = Object.assign(
        {
          page: 1,
          limit: _options.lastDocumentId !== undefined ? Infinity : 100,
        },
        _options
      );
